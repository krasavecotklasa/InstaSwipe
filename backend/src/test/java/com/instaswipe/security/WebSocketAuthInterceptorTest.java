...
class WebSocketAuthInterceptorTest {
    ...
    void testPreSend_SubscribeToOwnMatch_Success() {
        ...
        accessor.setLeaveMutable(true);
        // The principal is bound to the session at CONNECT and carried on subsequent frames.
        accessor.setUser(new UsernamePasswordAuthenticationToken("user123", null, List.of()));
